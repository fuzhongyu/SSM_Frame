...
import com.fzy.shop.annota_valide.valide_class.Valide_2;
...
//与约束注解关联的验证器(自定义验证方式)
@Constraint(validatedBy = {Valide_2.class})
...
public @interface ValideParam_2 {

    // 约束注解验证时的输出消息
    String message() default "this string maybe empty -2";
