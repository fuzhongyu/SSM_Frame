...
import com.fzy.shop.annota_valide.valide_class.Valide;
import com.fzy.shop.annota_valide.valide_class.Valide_3;
...
//与约束注解关联的验证器(自定义验证方式)
@Constraint(validatedBy = {Valide_3.class})
...
public @interface ValParam_3 {

    // 约束注解验证时的输出消息
    String message() default "this string maybe empty 3";
