...
import com.fzy.common.utils.CookieUtils;
...
public class Page<T> {
    ...
    private boolean isGetCount = true;//是否查询总数
     ...
     * @param pageNo 当前页码
     * @param pageSize 分页大小
     * @param isGetCount false不查询总数
     *
     */
    public Page(int pageNo, int pageSize, boolean isGetCount) {
        this(pageNo, pageSize, 0);
        setGetCount(isGetCount);
    }
